...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Конструктор по замовчуванню: " + apt);
        Apartment apt2 = new Apartment(111, 45.5);
        System.out.println("Перевантажений Конструктор 1: " + apt2);
        Apartment apt3 = new Apartment(112, 50.0, 3);
        System.out.println("Перевантажений Конструктор 2: " + apt3);
        Apartment apt4 = new Apartment(11, 103, 38.2, 2, 1, "Вулиця Синя");
        System.out.println("Повний конструктор: " + apt4);
        Apartment apt5 = new Apartment(apt4);
        System.out.println("Конструктор копіювання: " + apt5);
